...
trader.GasDetails = {
    ...
    [trader.GasBitFlag.Methane] = { name = "Methane", icon = "Methane" },
    [trader.GasBitFlag.Fuel] = { name = "Fuel", icon = "Methane" },
    ...
    [trader.GasBitFlag.LiquidMethane] = { name = "Liquid Methane", icon = "LiquidMethane" },
    ...
    [trader.GasBitFlag.Hydrazine] = { name = "Hydrazine", icon = "Hydrazine" },
    [trader.GasBitFlag.LiquidHydrazine] = { name = "Liquid Hydrazine", icon = "LiquidHydrazine" },
    [trader.GasBitFlag.LiquidAlcohol] = { name = "Alcohol", icon = "LiquidAlcohol" },
    [trader.GasBitFlag.Helium] = { name = "Helium", icon = "Helium" },
    [trader.GasBitFlag.LiquidSodiumChloride] = { name = "Liquid Sodium Chloride", icon = "LiquidSodiumChloride" },
    [trader.GasBitFlag.Silanol] = { name = "Silanol", icon = "Silanol" },
    [trader.GasBitFlag.LiquidSilanol] = { name = "Liquid Silanol", icon = "LiquidSilanol" },
    [trader.GasBitFlag.HydrochloricAcid] = { name = "Hydrochloric Acid", icon = "HydrochloricAcid" },
    [trader.GasBitFlag.LiquidHydrochloricAcid] = { name = "Liquid Hydrochloric Acid", icon = "LiquidHydrochloricAcid" },
    [trader.GasBitFlag.Ozone] = { name = "Ozone", icon = "Ozone" },
    [trader.GasBitFlag.LiquidOzone] = { name = "Liquid Ozone", icon = "LiquidOzone" },
}
